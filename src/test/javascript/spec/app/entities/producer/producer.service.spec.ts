    ...
    describe('Producer Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/producers';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Producer', () => {
                service.create(new Producer(null)).subscribe(received => {
            ...
            it('should update a Producer', () => {
                service.update(new Producer(123)).subscribe(received => {
